...
const CityPage = () => {
  ...
  return (
    <>
      <Helmet>
        <title>{seoMeta.title || `${cityData.name} – City Page`}</title>
        <meta
          name="description"
          content={
            seoMeta.description || `Explore profiles of women in ${cityData.name}.`
          }
        />
      </Helmet>
